...
const VideoPreview = ({ videoId, title, duration, channel }: VideoPreviewProps) => (
  <div className="animate-in fade-in zoom-in duration-500 rounded-2xl overflow-hidden glass-card">
    <div className="relative group">
      <img
        src={videoId === 'generic' ? '/Lumen-Lab-Favicon-BG-Removed.png' : `https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`}
        alt={title}
        className="w-full aspect-video object-cover"
        onError={(e) => {
          (e.target as HTMLImageElement).src = videoId === 'generic' 
            ? '/Lumen-Lab-Logo-BG-Removed.png' 
